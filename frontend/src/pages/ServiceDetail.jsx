...
const ServiceDetail = () => {
  ...
  return (
    <>
      ...
      <div className="pt-[120px] min-h-screen bg-gray-100 px-4 md:px-20 flex justify-center">
  <div className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col max-w-6xl w-full">
    ...
    <div className="p-6 flex flex-col gap-4">
      ...
      <p className="text-red-600 font-semibold text-xl">Price: ₹{service.price}</p>

      <div className="mt-4">
        <h2 className="text-2xl font-semibold text-blue-700 mb-2">
          Treatment Details
        </h2>
        <p className="text-gray-700 whitespace-pre-line">{service.treatment}</p>
      </div>
    </div>
  </div>
</div>
